...
When you run the `claude` command for the first time, it will prompt you to log in to your Anthropic account. The full setup guide is available at [docs.anthropic.com](http://docs.anthropic.com) if you need more detailed instructions.
